...
const isValidSecretKey = input => {
  try {
    FoneroSdk.Keypair.fromSecret(input);
    return true;
  } catch (e) {
    // console.error(e);
    return false;
...
export default class LoginPage extends React.Component {
  ...
  render() {
    ...
    if (this.state.invalidKey) {
      ...
      errorMessage = <div className="s-alert s-alert--alert">Unable to contact network. Please check your internet connection and allow connections to horizon.fonero.org. Maybe an adblocker or plugin (such as Privacy Badger) is preventing the client from communicating with the network.</div>
    }

    let newKeypairDetails;
    if (this.state.newKeypair !== null) {
      newKeypairDetails = <div className="LoginPage__generatedNote">
        <p><strong>Keep your key secure. This secret key will only be showed to you once. FoneroTerm does not save it and will not be able to help you recover it if lost.</strong></p>
    ...
    let acceptTerms = <label className="s-inputGroup LoginPage__accept">
        ...
        <span className="LoginPage__accept__label">I accept the <a href="#terms-of-use" className="LoginPage__accept__link">Terms of Use</a>, understand the risks associated with cryptocurrencies, and know that FoneroTerm does not issue or endorse any asset on the Fonero network.</span>
      </label>
    ...
    if (this.props.urlParts[0] === 'account') {
        ...
        <div className="LoginPage__greenBox">
          ...
          <div className="LoginPage__notes">
            ...
            <ul>
              ...
              <li>Foneroterm does not save your secret key. It is stored on your browser and will be deleted once the page is refreshed or exited.</li>
              <li>For extra security, you can <a href="https://github.com/foneroterm/foneroterm" target="_blank" rel="nofollow noopener noreferrer">build from source</a> or <a href="https://github.com/foneroterm/foneroterm.github.io/" target="_blank" rel="nofollow noopener noreferrer">download from GitHub</a> and verify the hash.</li>
              <li>FoneroTerm is released under the Apache 2.0. It is provided "AS IS" without warranty. The developer is not responsible for any losses and activities caused by the application.</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      body = <div className="LoginPage__body">
        ...
        <div className="LoginPage__greenBox">
          <div className="LoginPage__form">
            ...
            <p>To get started on using the Fonero network, you must first create a keypair (unless you have a Ledger Nano). The keypair consists of two parts:</p>
      ...
      if (d.session.ledgerConnected) {
        ...
        if (d.session.setupLedgerError) {
          ...
          // new FoneroLedger.Api(new FoneroLedger.comm(NUMBER))
        ...
        loginForm = <div className="LoginPage__form LoginPage__form--simpleMessage">
          <p className="LoginPage__form--title">Ledger only works on a https site.<br />Please use <a href="https://foneroterm.com/" target="_blank" rel="nofollow noopener noreferrer">https://foneroterm.com/</a></p>
        </div>
      } else if (!d.session.ledgerConnected) {
        loginForm = <div className="LoginPage__form LoginPage__form--simpleMessage">
          <p className="LoginPage__form--title">Scanning for Ledger Wallet connection<Ellipsis /></p>
          <p>Please plug in your Ledger and open the Fonero app. Make sure browser support is set to yes.</p>
      ...
      body = <div className="LoginPage__body">
        ...
        <div className="LoginPage__paddedBox">
          ...
          <ol>
            ...
            <li>Inside the Ledger Manager app, go to Applications and install the Fonero app.
              <br />
              <img src={images['ledger-app']} className="img--noSelect" alt="Fonero app installation inside Ledger Manager" width="355" height="77" />
            </li>
            <li>
              On your Ledger device, nagivate to the Fonero app and open the app.
              <br />
        ...
        <div className="LoginPage__paddedBox">
          ...
          <ul>
            ...
            <li>Install the Fonero app with the <a href="https://www.ledgerwallet.com/apps/manager" target="_blank" rel="nofollow noopener noreferrer">Ledger Manager</a>.</li>
