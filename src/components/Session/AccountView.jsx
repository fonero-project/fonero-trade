      ...
      <div className="so-back islandBack">
        <div className="island">
          ...
          <div className="Session__AccountView__content">
            By default, your account is only configured to accept <strong>FNO</strong>. In order to receive other assets, you must <a href="#account/addTrust">accept</a> them using the <strong>Accept assets</strong> tool.
          </div>
