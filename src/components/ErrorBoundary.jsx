  ...
  render() {
    if (this.state.hasError) {
      ...
      return <Generic title="An unknown error occured">
        ...
        <p><strong>Your funds are safe</strong> and not affected by this error. This error is just a display error in FoneroTerm, and is not your fault.</p>
        <pre>
